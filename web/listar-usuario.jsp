...
// capturamos la lista de errores
ArrayList errores = (ArrayList) request.getAttribute("listaErrores");
         ...
         <div id="contenido">
             <div class="cuenta1">
                 ...
                 <form method="post" action="servlet_EditarAdministrador"  >
                     ...
                     <li style="list-style: none"><%=errores.get(i)%></li>
                         <%}%>
                     <a href="editar-cuenta-administrador.jsp">Volver al buscador</a>
                     <%}%>
